            ...
            for app, kind, gs, category_name in sorted_tuples:  # we process the user type first
                ...
                if app.xml_id == 'base.module_category_user_type':
                    ...
                    for g in gs:
                        ...
                        if g.name == "Allow":
                            xml_by_category[(100, 'Product Creation Authorization')] = []
                            xml_by_category[(100, 'Product Creation Authorization')].append(E.newline())
                            xml_by_category[(100, 'Product Creation Authorization')].append(E.field(name=field_name, **attrs))
                            xml_by_category[(100, 'Product Creation Authorization')].append(E.newline())
                        elif g == group_no_one:
