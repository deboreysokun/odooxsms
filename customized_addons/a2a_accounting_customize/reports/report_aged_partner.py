...
class ReportAgedPartnerBalance(models.AbstractModel):
    ...
    def _get_partner_move_lines(self, account_type, date_from, target_move, period_length):
        ...
        #company_ids = self._context.get('company_ids') or [user_company.id] #allowed_company_ids
        company_ids = self._context.get('allowed_company_ids') or [user_company.id]
