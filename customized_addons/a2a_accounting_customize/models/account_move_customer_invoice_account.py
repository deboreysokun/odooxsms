...
class DiscountAccountMove(models.Model):
  ...
  # Modify account receivable that recorded
  # Copy code from account/models/account_move.py
  @api.onchange('partner_id')
  def _onchange_partner_id(self):
      self.acc_id = self.partner_id.property_account_receivable_id
      self._onchange_acc_id()

  @api.onchange('acc_id')
  def _onchange_acc_id(self):
  ...
  def _recompute_payment_terms_lines(self):
      ...
      def _compute_diff_payment_terms_lines(self, existing_terms_lines, account, to_compute):
          print("_compute_diff_payment_terms_lines")
